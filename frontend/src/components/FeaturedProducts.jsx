...
const FeaturedProducts = ({ featuredProducts }) => {
  ...
  const isStartDissabled = currentIndex === 0;
  const isEndDissabled = currentIndex >= featuredProducts.length - itemsPerPage;
  return (
    <div className="py-12">
      <div className="container px-4 mx-auto">
        ...
        <p className="mb-12 text-xl text-center text-gray-300">
          Explore our top picks for the season, featuring high-quality products
          at unbeatable value. Shop now!
        </p>
